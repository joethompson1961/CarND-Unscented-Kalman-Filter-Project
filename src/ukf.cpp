...
UKF::UKF() {
  ...
  std_laspx_ = 0.15;  // lidar measurement noise standard deviation position1 in m
  std_laspy_ = 0.15;  // lidar measurement noise standard deviation position2 in m
